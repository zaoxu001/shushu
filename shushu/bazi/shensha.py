...
:mod:`shushu.bazi.score` 的权重表里没有任何一项来自本模块，
:mod:`shushu.bazi.hepan` 也不看神煞。要把它当断语用，是调用方自己的选择，不是本包的建议。

起例的出处：天乙贵人、文昌、禄神、驿马、桃花（咸池）、华盖、将星、劫煞、亡神
见《三命通会·论诸神煞》与《渊海子平》；天德月德见《协纪辨方书》；
羊刃直接用 :data:`shushu.core.ganzhi.YANGREN`，只给阳刃，不替使用者在阴干刃上选边。
...
#: 文昌贵人：食神之临官位。《渊海子平》「甲乙巳午报君知，丙戊申宫丁己鸡……」
